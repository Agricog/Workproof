              ...
              {[
                {
                  ...
                  description: 'Camera roll mixed with family photos, holiday snaps, and that dodgy consumer unit from 6 months ago.',
                },
                {
                  icon: Clock,
                  title: 'No Timestamps',
                  description: 'When was that photo taken? Which job was it? Good luck proving it to the assessor.',
                },
                {
                  icon: MapPin,
                  title: 'No Location Data',
                  description: 'That photo could be from anywhere. No GPS proof means no credibility.',
                },
              ].map((item, index) => (
              ...
              {[
                {
                  icon: MapPin,
                  title: 'GPS-Tagged',
                  description: 'Every photo includes precise GPS coordinates. Prove you were on-site, not in the van.',
                  color: 'blue',
                },
                {
                  icon: Clock,
                  title: 'Timestamped',
                  description: 'Device timestamp captured at the moment of shutter click. Cannot be backdated.',
                  color: 'purple',
                },
                {
                  icon: Lock,
                  title: 'Tamper-Proof Hash',
                  description: 'SHA-256 cryptographic hash locks in the evidence. Any modification is detected.',
                  color: 'green',
                },
                {
                  icon: CloudOff,
                  title: 'Works Offline',
                  description: 'No signal in that basement? No problem. Capture now, sync later.',
                  color: 'amber',
                },
                {
                  icon: FileCheck,
                  title: 'Audit Pack Generation',
                  description: 'Filter by date, site, or task. Export NICEIC-ready PDF with hash verification.',
                  color: 'cyan',
                },
                {
                  icon: Smartphone,
                  title: 'Any Device',
                  description: 'Works on iPhone, Android, tablet, or desktop. No app store download required.',
                  color: 'pink',
                },
              ].map((feature, index) => (
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: 'Follow the checklist. Each photo is GPS-tagged, timestamped, and hashed automatically.',
                },
                {
                  step: '3',
                  title: 'Generate Audit Pack',
                  description: 'Filter by date range, export PDF with hash verification. Assessment ready.',
                },
              ].map((item, index) => (
